        ...
        <div class="flex px-6">
            ...
            <div>
                <ul role="list" class="mt-3 grid grid-cols-1 gap-5 sm:gap-6 sm:grid-cols-2 lg:grid-cols-4">
                                ...
                                <div class="flex-shrink-0 pr-2" x-data="{action:false}">
                                    ...
                                    <div x-show="action" x-cloak @click.away="action=false"
                                        ...
                                        <div class="py-1" role="none">
                                            ...
                                            <button wire:click="delete({{ $partylist->id }})"
                                                class="text-gray-700 block px-4 py-2 text-sm" role="menuitem"
                    ...
                    @empty
                        <span class="bg-main text-white px-2 rounded-md shadow-sm">No partylist Available</span>
                    @endforelse
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div x-show="add" x-cloak x-transition:enter=" ease-out duration-300"
                ...
                <div class="flex px-2 border-b py-1 justify-between items-center">
                    <h1 class="font-bold uppercase text-main">ADD partylist</h1>
                ...
                <div class="p-3 px-10">
                    <div class="mb-1">
                        <label for="email" class="block text-sm font-medium text-gray-700">Partylist Name</label>
                        <div class="mt-1">
                    ...
                    <div class="mb-1">
                        ...
                        <div class="mt-1">
                            <input wire:model="description" type="email" name="email" id="email"
                                class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md"
                                placeholder="">
                        </div>
                    </div>
                    <div class="mb-1">
                        <label for="email" class="block text-sm font-medium text-gray-700">Propaganda</label>
                        <div class="mt-1">
                            {{-- <input wire:model="propaganda" type="email" name="email" id="email"
                                class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md"
                                placeholder=""> --}}
                            <textarea name="" id="" wire:model="propaganda" cols="30" rows="2"
    ...
    <div x-show="edit" x-cloak class="fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog"
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div x-show="edit" x-cloak x-transition:enter=" ease-out duration-300"
                ...
                <div class="bg-blue-600 h-1 w-full"></div>
                <div class="flex px-2 border-b py-1 justify-between items-center">
                    <h1 class="font-bold uppercase text-main">EDIT partylist</h1>
                    <button @click="add = false" class="hover:text-red-600">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
                            fill="currentColor">
                            <path fill-rule="evenodd"
